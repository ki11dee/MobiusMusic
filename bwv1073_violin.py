...
measure2.append(note.Note('C3', quarterLength=1))
measure2.append(note.Note('C3', quarterLength=0.5))
...
violin.append(measure1)
violin.append(measure2)
violin.repeatAppend(repeat_section, 2)  # 도돌이표 부분 2번 반복
violin.append(repeat_section_end)

# 마디 3
measure3 = stream.Measure()
measure3.append(note.Note('G3', quarterLength=0.5))
measure3.append(note.Note('A3', quarterLength=0.25))
measure3.append(note.Note('G3', quarterLength=0.25))
measure3.append(note.Note('F3', quarterLength=0.5))
measure3.append(note.Note('E3', quarterLength=0.5))
measure3.append(note.Note('D3', quarterLength=4))

violin.append(measure3)


from transpose_function1 import transpose_part_handle

violin_mod = transpose_part_handle(violin, 14)

# violin_mod.show('text')
# violin_mod.show('midi')